Create Codex v2 pet look row 9 for `chatgpt-longniang` as exactly 8 full-body frames in this order: 000, 022.5, 045, 067.5, 090, 112.5, 135, 157.5.
...
RIGHT-HALF LANDMARK LOCK: frames 2-8 must never read screen-left. Move the nose/face plane and both complete irises toward SCREEN-RIGHT, with progressive cheek/ear/horn reveal and far-side occlusion. Make `090` a clear screen-right three-quarter/profile. Make `000` unmistakably UP using high irises with visible eye-fill below, lifted lids/brows and a lifted chin.
