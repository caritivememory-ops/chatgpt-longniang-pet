Create one horizontal animation strip for Codex pet `chatgpt-longniang`, state `running-right`.
...
State requirements:
- HARD GATE: every frame must read as facing and travelling toward the viewer's screen-right edge, not front-facing. Turn the eyes, nose/face plane, head, torso and leading limbs toward screen-right; show at least two strongly readable right-facing profile or three-quarter poses. Hair, tassels, folded wings and the large curled tail may lag toward screen-left while remaining attached to their canonical anatomical sides.
- Make the alternating gait unmistakable: the leading and trailing feet/legs must exchange positions across neighboring frames while the head keeps the same rightward direction.
